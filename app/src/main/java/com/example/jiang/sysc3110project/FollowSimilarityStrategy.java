...
/**
 * Shared follow Similarity Strategy 
 * @author  Mohamed Dahrouj, Lava Tahir, Ali Farah, Zening Jiang
 * @version 3.0
 *
 */
public class FollowSimilarityStrategy extends Strategy{
	private Simulation simulate;
	public FollowSimilarityStrategy(Simulation s){
		this.simulate = s;
	}
